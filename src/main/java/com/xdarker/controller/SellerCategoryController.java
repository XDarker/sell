...
import com.xdarker.form.CategoryForm;
...
public class SellerCategoryController {
    ...
    @Autowired
    public SellerCategoryController(ICategoryService iCategoryService) {
    ...
    public ModelAndView save(@Valid CategoryForm form,
        ...
        try {
            if (form.getCategoryId() != null) {
                productCategory = iCategoryService.findOne(form.getCategoryId());
            }
