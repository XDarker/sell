...
import com.xdarker.form.ProductForm;
...
public class SellerProductController {
    ...
    @Autowired
    public SellerProductController(IProductService iProductService, ICategoryService iCategoryService) {
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<ProductInfo> productInfoPage = iProductService.findAll(request);
    ...
    public ModelAndView save(@Valid ProductForm form,
        ...
        try {
            ...
            if (!StringUtils.isEmpty(form.getProductId())) {
                productInfo = iProductService.findOne(form.getProductId());
            } else {
